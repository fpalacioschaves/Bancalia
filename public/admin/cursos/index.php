...
<form method="get" action="" class="mb-5 grid grid-cols-1 gap-3 sm:grid-cols-[1fr,240px,auto,auto] items-stretch">
  ...
  <input id="q" type="search" name="q" value="<?= h($q) ?>" placeholder="Buscar por curso, slug o familia"
  ...
  <a href="<?= PUBLIC_URL ?>/admin/cursos/create.php"
...
<?php if (!$rows): ?>
  <div class="rounded-lg border border-slate-200 bg-white p-6 text-slate-600">
    ...
    <a href="<?= PUBLIC_URL ?>/admin/cursos/create.php" class="text-indigo-600 hover:underline font-medium">Crea el
      primero</a>.
  </div>
<?php else: ?>
          ...
          <tr class="hover:bg-slate-50">
            ...
            <td class="px-4 py-3 text-sm">
              <div class="flex justify-end gap-2">
                ...
                <form method="post" action="<?= PUBLIC_URL ?>/admin/cursos/delete.php"
