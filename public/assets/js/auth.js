  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (regForm){
      ...
      const updateCursoYAsig = async ()=>{
        ...
        }catch(e){ console.error(e); show(alert,'No se pudo cargar cursos/asignaturas','err'); }
      };
      (async ()=>{
      ...
      regForm.addEventListener('submit', async (e)=>{
        ...
        if (payload.rol === 'profesor') payload.asignatura_id = parseInt(fd.get('asignatura_id')||'0',10);
